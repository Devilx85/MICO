...
#define MCCONST_H_INCLUDED
    ...
    int const _C_T_CSQ = 113;
    int const _C_T_OPT = 114;
    int const _C_T_OPTC = 115;
    int const _C_T_VAR = 116;

    int const _C_CF_ANY = 200;
    int const _C_CF_TYPE = 201;
